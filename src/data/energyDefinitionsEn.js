export const energyDefinitionsEn = {
  "oil": {
    ...
    related: ["fossil fuels", "oil products", "crude oil"],
    dataset: "nrg_bal_c",
  ...
  "renewable energy": {
    ...
    dataset: "nrg_ind_ren",
    additionalDatasets: ["nrg_bal_c", "nrg_ind_peh"],
    fuelCode: "RA000",
    nrg_bal: "PPRD",
    siec: "RA000",
    unit: "TJ_GCV",
  ...
  "energy efficiency": {
    ...
    dataset: "nrg_ind_eff",
    additionalDatasets: ["nrg_bal_c", "nrg_ind_eff"],
    fuelCode: "TOTAL",
    nrg_bal: "FEC_EED",
    siec: "TOTAL",
    unit: "TJ_GCV",
  ...
  "energy mix": {
    ...
    dataset: "nrg_bal_c",
    additionalDatasets: [ "nrg_ind_peh"],
    fuelCode: "TOTAL",
    nrg_bal: "PPRD",
    siec: "TOTAL",
    unit: "TJ_GCV",
...
"solid fossil fuels": {
  ...
  description: "Solid fossil fuels include hard coal, lignite, and their derivatives like coke and patent fuel. These fuels are commonly used in power generation, industrial processes, and heating applications. The data covers aspects such as production methods (surface and underground mining), trade flows, and consumption patterns across different sectors.",
  key_concepts: [
    "Underground and surface mining technologies",
    "Coal grades and quality specifications",
    "Trade patterns and partner countries",
    "Sectoral consumption breakdown",
    "Environmental impacts and efficiency measures"
  ],
  dataset: "nrg_bal_c",
  additionalDatasets: [],
  fuelCode: "C0000X0350-0370",
...
"nuclear fuel": {
  title: "Nuclear Fuel",
  description: "Nuclear fuel refers to the materials used in nuclear power plants to generate electricity through nuclear fission. This includes various stages of the fuel cycle from uranium enrichment to spent fuel management. The data covers production, capacity, and management of nuclear fuels including fresh fuel, MOX fuel, and nuclear heat production.",
  key_concepts: [
    "Uranium enrichment process",
    "Fuel fabrication and types",
...
"nuclear infrastructure": {
  ...
  description: "Nuclear infrastructure encompasses the facilities and systems required for nuclear power generation, including enrichment plants, fuel fabrication facilities, and power plants. The data covers production capacities, operational metrics, and fuel management facilities across the nuclear fuel cycle.",
  key_concepts: [
    "Enrichment capacity",
